...
public class ThreeDeeNessGuiProvider implements GuiProvider {
	...
	public static Object abstractSliderButton = null;
	...
	public List<AbstractConfigListEntry> get(String i13n, Field field, Object config, Object defaults, GuiRegistryAccess registry) {
		...
		var sliderEntry = ConfigEntryBuilder.create()
		...
		abstractSliderButton = sliderEntry.children().getFirst();

		return Collections.singletonList(sliderEntry);
	}
}
